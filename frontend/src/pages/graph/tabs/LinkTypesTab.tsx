...
import { Row, Col, Card, Tag, Typography, Space, Segmented, Tooltip } from 'antd'
...
const TYPE_COLOR: Record<string, string> = {
  ...
  Action: 'orange', MarketEvent: 'gold', Client: 'magenta', Strategy: 'volcano',
}
  ...
  return (
    ...
    >
      ...
      <Space style={{ marginBottom: link.description ? 10 : 0 }} size={8} wrap>
        ...
        {link.reverseName && (
          <Text type="secondary" style={{ fontSize: 12 }}>反向：{link.reverseName}</Text>
        )}
...
export default function LinkTypesTab() {
